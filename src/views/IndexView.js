            ...
            <div className="body">
              ...
              <div className="section is--80padding no-bottom wf-section">
                <div className="_1077_container">
                    ...
                    >
                      <div className="overflow_hidden">
                        ...
                        <div className="text--20">
                          ...
                          <br />· Buy with DAI or USDC on Ethereum Mainnet
                          <br />· Buy with fiat{" "}
                          ...
                          <br />‍<br />
                          <a
                            href="https://www.notion.so/web3creatives/Offscript-Terms-and-conditions-569cc25f4714418b9055bdac45ffbc94?pvs=4"
                            target="_blank"
                          >
                            Terms &amp; Conditions
                          </a>
                  ...
                  <div className="text--20 _60margin-top">
